...
Next, install this generator (in generator path):
...
Running a generator:
    ...
    yo ang:directive my-awesome-directive
    yo ang:partial my-partial
    yo ang:service my-service
    yo ang:filter my-filter
    yo ang:module my-module
    yo ang:modal my-modal
...
Submodules allow you to more explicitly separate parts of your application.  Use the `yo ang:module my-module` command and specify a new subdirectory to place the module into.  Once you've created a submodule, running other subgenerators will now prompt you to select the module in which to place the new component.
...
* 9/06/2013 - V1.0.4 - Fixed templating issue with generated specs for `yo ang:service` subgenerator.
